...
namespace backend.Migrations
{
    ...
    [Migration("20260625113917_AddRequesterAndAssignedAgentToTickets")]
    partial class AddRequesterAndAssignedAgentToTickets
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.Ticket", b =>
                {
                    b.HasOne("backend.Models.AppUser", "AssignedAgent")
                        .WithMany()
                        .HasForeignKey("AssignedAgentId");

                    b.HasOne("backend.Models.AppUser", "Requester")
                        .WithMany()
